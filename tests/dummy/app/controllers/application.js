...
export default Controller.extend({
  ...
  //myContent: new Ember.RSVP.Promise((res) => setTimeout(() => res(A([c1, c4, c6, c7])), 3000)),
  myContent: A([Ember.RSVP.resolve(c1),Ember.RSVP.resolve(c4),Ember.RSVP.resolve(c6),Ember.RSVP.resolve(c7)]),
