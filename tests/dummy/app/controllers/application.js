...
const c9 = { id: '9', label: 'b1sub', children: [] };
const c4 = { id: '4', label: 'B',  children: [c5] };
const c6 = { id: '6', label: 'C',  children: [] };
const c7 = { id: '7', label: 'D',  children: [], expand: true };
const c1 = { id: '1', label: 'A',  children: [c2, c3, c6, c7], expand: true};
// const c1 = { id: '1', label: 'A',  children: [c2, c3, c6, c7], expand: true, collapseLimit: 1 };
// const c1 = { id: '1', label: 'A',  selectionLimit:2, children: [c2, c3, c6, c7], expand: true, collapseLimit: 2 };
